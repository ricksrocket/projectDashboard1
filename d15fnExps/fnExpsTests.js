...
/* 1.	1.	Write a function, double, that takes a number and returns 2 times the 
number..  */
...
describe("times100", function () {
    ...
    /* 3.	Write a function, myMap, that takes an array and a function and returns a new array that has the function a
    pplied to each element of the input array. */
    ...
    describe("myMap", function () {
        ...
        it("tests myMap on triples anonymous function", function () {
            assert.deepStrictEqual(myMap(testArray,  testArray, function (num) { return 3 * num;}), [-30, 0, 30, 60]);
        });
        it("tests myMap on triples arrow function", function () {
            assert.deepStrictEqual(myMap(testArray, num => { return 3 * num;}), [-30, 0, 30, 60]);
        });
    });
