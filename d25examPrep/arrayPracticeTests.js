...
describe("filter practice", function () {
    ...
    it("Include even age ", function () {
        assert.deepEqual(includesEvenAge(peopleArray),
            [{ name: "William", age: 6 }, { name: "Barney", age: 80 }]);
        const peopleOddAge = [{ name: "Sam", age: 15 }, { name: "Lucy", age: 13 }, { name: "Barney", age: 81 }];
       assert.deepEqual(includesEvenAge(peopleOddAge), undefined);
    });
